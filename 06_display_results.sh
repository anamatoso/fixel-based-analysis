...
fixel2tsf "template/stats_${metric}/fwe_1mpvalue.mif" template/tracks_100k_sift.tck "template/${metric}fwe_1mpvalue.tsf"
...
mrview -load template/wmfod_template.mif -tractography.load template/tracks_100k_sift.tck -tractography.tsf_load tsf "template/${metric}fwe_1mpvalue.tsf" -tractography.tsf_thresh 0.95,1