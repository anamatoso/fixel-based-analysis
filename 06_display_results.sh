...
fixel2tsf "template/stats_${metric}/fwe_1mpvalue_t1.mif" template/tracks_100k_sift.tck "template/${metric}_fwe_1mpvalue.tsf" -force
...
mrview -load template/wmfod_template.mif -tractography.load template/tracks_100k_sift.tck -tractography.tsf_load "template/${metric}_fwe_1mpvalue.tsf" -tractography.tsf_thresh 0.95,1 -mode 4 -plane 2 -tractography.tsf_range 0.95,1