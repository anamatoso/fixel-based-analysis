...
for_each subjects/* : warp2metric IN/subject2template_warp.mif -fc template/fixel_mask template/fc PRE.mif


mkdir template/log_fc
cp template/fc/index.mif template/fc/directions.mif template/log_fc
for_each subjects/* : mrcalc template/fc/PRE.mif -log template/log_fc/PRE.mif
...
for_each subjects/* : mrcalc template/fd/PRE.mif template/fc/PRE.mif -mult template/fdc/PRE.mif
